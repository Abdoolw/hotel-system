        ...
        <div class="container">
            <div class="row site-hero-inner justify-content-center align-items-center">
                <div class="col-md-10 text-center" data-aos="fade-up">
                    <span class="custom-caption text-uppercase text-white d-block  mb-3">Welcome To 5 Stars<span
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($room as $room)
                    <!-- تأكد من استخدام جمع $rooms -->
                    <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up"> <!-- إضافة mb-4 للفاصل بين العناصر -->
                        <a href="#" class="room">
                            <figure class="img-wrap">
                                <img src="/images/{{ $room->image }}" alt="Free website template size-12"
                ...
                @foreach ($event as $event)
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
                        <div class="media media-custom d-block mb-4 h-100">
                            <a href="#" class="mb-4 d-block"><img src="/images/{{ $event->image }}"
                                    alt="Image placeholder" class="img-fluid"></a>
                            <div class="media-body">
                                <span class="meta-post">{{ $event->created_at->format('d/m/Y') }}</span>
                                <h2 class="mt-0 mb-3"><a href="#">{{ $event->title }}</a>
                                </h2>
